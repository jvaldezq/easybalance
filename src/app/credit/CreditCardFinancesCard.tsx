...
import { ICreditCardFinance, ICURRENCY } from '@/lib/definitions';
import {
  CRCFormatter,
  PercentageFormatter,
  USDFormatter,
...
export const CreditCardFinancesCard = (props: ICreditCardFinance) => {
  const { bank, interestAnual, currency, balance, monthlyPayment } = props;
